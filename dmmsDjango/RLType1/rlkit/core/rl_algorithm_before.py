...
class MetaRLAlgorithm(metaclass=abc.ABCMeta):
        ...
        for it_ in gt.timed_for(
            ...
            if it_ == 0:
                ...
                for idx in self.train_tasks:  # 依次收集每个任务的 initial pool
                    ...
                    db.commit()  # 提交
                    with open('/home/yanlian/DMMSDjango/dmmsDjSA_end/dmmsDjango/results/dataDeal2.txt', 'a+') as dfile:
                        dfile.write('\npatient:' + str(idx + 1) + '\n')
                    self.task_idx = idx
    ...
    def _try_to_eval(self, epoch):
        ...
        if self._can_evaluate():  # True
            ...
            with open('/home/yanlian/DMMSDjango/dmmsDjSA_end/dmmsDjango/results/Epochrecord.txt', 'a+') as dfile:
                dfile.write(
